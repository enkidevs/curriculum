...
Now that you know a little bit about Java, it is time to show you how to build your first app. Probably the most used first code snippet for any language is the `hello world` one. Here it is:
```
