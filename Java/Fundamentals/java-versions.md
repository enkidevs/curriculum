...
One way to avoid this from happening is by stopping public support for older versions, which has already happened. As of 2015, *Java 8* is the only publicly supported version.
...
What's the only publicly supported **Java** version as of 2015 ?
