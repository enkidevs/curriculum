...
1. Strict *Dependency Injection* Mode:
...
2. Disabling comments and CSS class directives:
...
3. Disabling Debug Data:
    ...
    ```
    Use the code above to debug an application with the information above in the debug console. 
