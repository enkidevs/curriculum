...
This means that **JSX** is a way of writing **HTML** inside `JS` code.
...
**React** doesn't require **JSX** usage, but using it is highly encouraged along with compiling with `Babel`.
---
## Practice
