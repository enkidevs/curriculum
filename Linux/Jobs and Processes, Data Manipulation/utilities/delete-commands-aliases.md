...
[1] The `rm` (i.e., remove) command is used to delete files and directories.
[2] The `mv` (i.e., move) command is used to move or rename files.
[3] The `cp` (i.e., copy) command is used to make copies of files and directories.