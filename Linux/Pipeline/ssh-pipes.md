...
What would the sequential action flow for copying compressed files to a server be?
```
1. ???
2. ???
3. ???
4. ???
```
You would also want to delete the archive on your machine. This is why piping the result might be better.
