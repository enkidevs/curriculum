...
- `AssertionError`   : raised in case of failure of the **Assert statement**[1].
...
[1:AssertionError]
An AssertionError is an error generated by the program to show that something that should never happen, has happened. It informs the developers about urecoverable errors.
