...
1.  The value of the current node should be the _maximum_ value among all the values in the left sub-tree
2.  The value of the current node should be the _minimum_ value among all the values in the right sub-tree
...
Is the following a _binary search tree_?
