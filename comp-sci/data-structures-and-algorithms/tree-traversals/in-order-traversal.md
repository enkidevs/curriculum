...
**In-order traversal** is a type of _depth-first traversal_ in which the _root_ of the tree is visited after the left child and before the right child. It only makes sense for _binary trees_.

It works like this:

- Traverse the *left subtree *recursively.
- _Modify/Display_ the data of the current node (starting with the root).
- Traverse the _right subtree_ recursively.
...
_In-order traversal_ will visit nodes in the following order:
