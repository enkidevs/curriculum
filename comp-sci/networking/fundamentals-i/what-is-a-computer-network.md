...
Usually, nodes include **hosts** such as _PCs_, _servers_, _phones_, but also _network hardware_[1]. Two such devices are said to be _networked_ when one of them is able to _exchange information_ with the other.
...
While modern devices have network devices integrated into their circuit boards, older ones counting PCs or XBox game consoles need a _peripheral_ network device, such as _USB adapters_ or _Network Interface Cards_ (NIC).
