...
For example, you can change your *name* and *email* address so that work you perform in **Git** shows your identity.
...
Complete the command to change your name for all projects:
```
$ git ??? ??? \
  user.??? "My Name"
```
