...
It's important for a team member to know how to manage (_add_, _remove_, etc.) and work with data (_push_ and _pull_ changes) from remote repositories to be able to collaborate effectively.
