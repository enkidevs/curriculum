...
To start an _interactive_ rebase you use the `-i` flag:
...
If you look at the history, it will seem like all the changes happened in series when they were actually made in parallel. Keep in mind that rebasing shouldn't be done to _public_ projects as this operation can lead to terrible confusion because history is being overwritten.
