...
You then decide what you want to do with each _hunk_ (couple of lines of changed code) by selecting one of the options:
...
The hunk above contained the first 2 line changes in the _README_ file. You will be presented with a new _hunk_ until you have gone through all the changes.
