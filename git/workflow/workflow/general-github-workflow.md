...
**GitHub** enhanced **Git**'s collaboration capability with the `pull request`, providing a _GUI_ way to generate a 'patch'.
...
Is the concept of **pull requests** only used in _GitHub_?
