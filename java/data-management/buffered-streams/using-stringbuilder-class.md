...
- create `"Good Morning"` by concatenating the first two and put it in the _Heap_.
...
Unlike `String`, `StringBuilder` class behaves as an _array of characters_, providing **mutable** objects.
