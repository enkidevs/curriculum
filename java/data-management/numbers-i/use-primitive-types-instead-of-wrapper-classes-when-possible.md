...
The first comparison is faster than the second, as the first compare values but the second has additional checks about the objects being instances of the Integer.
