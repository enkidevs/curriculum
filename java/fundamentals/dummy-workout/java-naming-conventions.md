...
- Method names should begin with a lower-case letter, but all subsequent words in the method name should begin with a capital letter; this is called _camel case_. E.g. `getPhoneNumber`.
- Variable names should also be _camel case_.
