...
- The rest of the characters can be letters, currency symbols, underscore, digits, numerals and combining marks. _Whitespaces_ are not allowed.
- The identifiers must not be a _reserved word_ (such as `while`, `if`, `break`).
