...
What's odd about Java is that _character sequences_, or _strings_, are not _primitives_. However, because they are so often used, `String`s have priority over other classes.
