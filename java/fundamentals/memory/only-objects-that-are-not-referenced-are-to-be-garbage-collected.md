...
In order for a _Java_ object to be automatically garbage collected, all the references to it must be _nullified_.

For garbage collection to work on a specific object, any other objects that act as references to the first one must also be _nullified_.
