...
- If the object had a `transient` field then upon deserialization, the new field will be assigned with default values such as: `null` for an _object_, `0` for an _int_, `false` for a _Boolean_, etc.
