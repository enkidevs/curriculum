...
_Java_ `toString()` method is inherited by any object, both user defined or provided by the JDK.
...
The _PrintStream_ method `println()` will invoke the `toString()` method, directly printing the relevant information.
