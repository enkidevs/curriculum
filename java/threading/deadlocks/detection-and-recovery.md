...
One of the necessary conditions for a deadlock is a _circular wait_, i.e. somewhere in this graph there will be a cycle of process-resource dependency which is the cause of the deadlock.
