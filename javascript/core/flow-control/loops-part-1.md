...
The _while_ loop continues to run as long as the expression in brackets is true.
...
_do while_ loops are similar to while loops but have the important difference that they will always run at least once before the condition is checked:
