...
_for in_ loops allow you to iterate through an objects keys. E.g. the keys below are firstName and lastName:
...
_for of_ loops are used with iterable objects such as arrays & maps and allow you to easily loop through an iterables values:
...
_for of_ loops will only iterate over an objects values and **not** inherited properties like the _for in_ loop will.
