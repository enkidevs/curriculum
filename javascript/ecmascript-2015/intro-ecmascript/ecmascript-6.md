...
We'll be looking at features such as constants, arrow functions, the spread/rest operator, default parameters, extensions to existing types, and much more!

It's important to note that if you intend to use some of the features that we will discuss, support for them varies widely across browsers and is changing all the time.
...
Which of the following statements about ES6 are false?
