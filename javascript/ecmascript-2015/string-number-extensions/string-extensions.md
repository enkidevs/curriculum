...
In previous versions of EcmaScript if you wanted to use Unicode characters one method was to use _String.fromCharCode_:

```javascript
String.fromCharCode(65); /A
```

However _fromCharCode_ doesn’t work with all possible unicode values.

ES6 introduces a new method _fromCodePoint_ that can be used to work with all Unicode values up to 21 bits:
