...
_npm3_ tries to fix it by flat installing the same version of PackageA other packages are using. For example, PackageB and PackageC depend on versions 1.0.0 and 1.1.0, respectively, of PackageA. For the following _package.json_:
...
The _node_modules_ directory tree looks like this:
...
What do you think would happen with the project's _node_modules_ structure if the _package.json_ order of dependencies changes?
...
It doesn't seem like much, but be aware of this behavior as it might cause _not working on my machine_ bugs.
