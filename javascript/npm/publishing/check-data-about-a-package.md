...
The _latest version_ of the package is targeted by default. However, older versions can be specified as well:
...
The output of the _npm view_ command is structured like a _JavaScript_ object, so you could get nested data as such:
...
Complete the command to retrieve the contributors to the _npm_ package:
