...
After you have set up the _package.json_ file, it's time to start coding. A npm module is a regular JavaScript file that must follow the _CommonJS_ module spec.
