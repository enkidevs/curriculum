...
If you decide to publish your module, a good _README.md_ file is necessary. It does not only help you keep track of the capabilities of the module, but also it helps others understand how to use your module.
...
Scoped packages are private by default, but you have to pay a subscription to keep them private. It is free, however, to publish _public packages_. In case your module is scoped and you want it to be public, run:
