...
**Functional components** are preferred for **UI** because they enforce the best practice of having _dumb presentational components_, but also require less typing (e.g. no `this` keyword).
