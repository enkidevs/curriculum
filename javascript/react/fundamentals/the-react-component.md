...
In **React** a `component` represents a fundamental _class_ you can work with to build re-usable and independent `UI` blocks.

These `component`s behave like simple functions, they can take input arguments called `props` and will return what should be _rendered_.

The _rendered_ output needs to be specified inside a function called `render()`.
