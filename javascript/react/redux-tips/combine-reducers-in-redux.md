...
# Combine _reducers_ in **Redux**

---

## Content

When applications become more complex, the _reduction function_ can and should be split into separate functions, managing different parts of the **state** as to keep the code logic tidy and scalable. This is done by using the special method `combineReducers()`.
