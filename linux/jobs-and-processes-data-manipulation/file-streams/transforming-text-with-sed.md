...
The `sed` command (short for _stream editor_) is used to manipulate a stream of text one line at a time. A common use-case is altering the contents of a file or output of another program one line at a time.
...
2.  **More Advanced Text Replacement**
    ...
    Likewise, this will remove any _leading_ whitespace from each line, aligning all text flush left:
...
Replace the first apparition of _apple_ in each line by _orange_:
