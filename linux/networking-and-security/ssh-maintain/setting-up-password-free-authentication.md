...
The command will make you connect to the server, paste your key into the _authorized_keys_ file on the server and ensure that you are the only one who can access the file by setting up permissions.
