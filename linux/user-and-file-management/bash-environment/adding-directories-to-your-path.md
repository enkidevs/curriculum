...
You can open _.bashrc_ in terminal by running:
...
For example, to add the directory _/usr/sbin_, the following would be used:
...
Sourcing executes the file that it was given as a parameter. To source your _.bashrc_, simply type
