...
You can give a user _root privileges_ (`sudo` access) by following the syntax above. This is what each field means:
...
- A user that can _always_ run _all_ the commands with elevated privileges.
