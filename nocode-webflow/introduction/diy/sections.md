...
A section is a layout element with a default width of 100% (full width of the browser) and a default height of 0.
...
Having these `sections` lets us easily section the content of the webpage, in this case, a toy store.
