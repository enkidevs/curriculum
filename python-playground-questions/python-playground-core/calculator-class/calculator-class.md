...
Start by creating the `Calculator` class.

Then define the initial method with `self` and two variables.

Inside the method, access each variable using `self`.

Next, create four different methods `subtract`, `multiply`, `add`, and `divide`.
