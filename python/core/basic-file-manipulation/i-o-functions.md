...
- `casting` function (which would **cast** the input into the needed _data type_)
- `eval`[3] function (which would interpret `string`s as Python _code_ and evaluate it)
