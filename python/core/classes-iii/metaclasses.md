...
In Python, _classes_ are also _objects_. Just like any other object, they must be an instance of something: in this case, a **metaclass**. You can find out the base metaclass of a class through:
...
In other words, to create an instance of a class, there's not only the _class_ that has to be considered, but also the _metaclass_:
