...
Python's `return` statement exits a function and passes back an expression to the function caller. It's used to return the _flow of control_ with an _output result_ to the function call.
