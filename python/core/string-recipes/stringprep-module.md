...
The **RFC 3454** international memo defines the procedure of _preparing_ Unicode string as to be suitable for internet protocols. It basically provides a set of specialized tables of code points.
