...
**Pytest** is a **testing framework**. Despite being a fully-featured and extensible test tool, it has a simple syntax. Creating a _test suite_ means writing a **module** with a couple of functions.
