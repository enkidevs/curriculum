...
**Decorators**, or function decorators, are _wrappers_ to existing functions, built using the concept of _higher-order functions_ (closures).
...
Say you need to wrap the output of the function in _heading tags_, like this:
...
We've mentioned _higher-order functions_ in the introduction. Try and figure out where the concept is used in `h2_decorate`'s function definition.
