...
In summary, collections of objects and custom classes are almost always **mutable**. Scalar (or _base_) data types[1] are usually **immutable**. The only exceptions to these rules are:
