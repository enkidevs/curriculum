...
As you can imagine, 255 characters is nowhere near enough to map every symbol of every alphabet in the world. For reference, there are around 180 emoticons in only the first emoji tab ('Smileys and People'). This was an issue that had to be dealt with quickly.
