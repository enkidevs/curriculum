...
The `LIKE` statement accepts a pattern string, where wildcard characters are used to denote an acceptable pattern. _Note that some databases may have a different implementation of the specific wildcard characters_
