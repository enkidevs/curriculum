...
Let's take PostgreSQL on MacOS X as an example. After the default installation (link provided in 'learn more' section), we have to go to _/Library/PostgreSQL/9.6/bin_ folder and run the `psql` binary file with proper arguments:
