...
**hostname** is the address of the server the database is located on. If the database you are connecting to is *on your computer*, this value will be `localhost` or `0.0.0.0`. If it is *remote*, you will enter a hostname like `aws-us-east-1-portal.29.dblayer.com`.  
