...
For each unsorted employee, you compare their height to the employee in the middle of the sorted line, then go left if their height is smaller or right if their height is equal to or larger than the middle employee's height.
