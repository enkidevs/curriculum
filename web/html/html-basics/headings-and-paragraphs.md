...
The difference between _headings_ and _paragraph_ is that the former are inherently bold. While a `<h4>` element has the same font size as `<p>`, `<h6>` is almost one third smaller.
