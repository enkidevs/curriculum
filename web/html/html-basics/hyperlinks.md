...
The main difference between `<p>` and `<a>` elements is that you can click on anchor tags and they will take you somewhere. To visually represent that ability, their default color is _blue_ and they are _underlined_.
