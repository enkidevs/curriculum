...
**Images** are _self-enclosing elements_, which display external pictures.They are delimited by the `<img/>` tag.
...
By default, if the image fits inside the screen, it will be displayed depending on its resolution. A _600×400_ image's width will be _600_ and its height will be _400_.
