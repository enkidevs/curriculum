...
In HTML the browser assumes _<_ and _>_ always represent the start and end of an HTML tag. If we need to display the literal characters, _<_ or _>_, we must use character entities.

You can use either an HTML entity _name_ or an HTML entity _number_
