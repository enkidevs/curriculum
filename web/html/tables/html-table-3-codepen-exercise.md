...
links:
  ...
  - >-
    [MDN docs for
    thead](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/thead){website}
  - >-
    [MDN docs for
    tbody](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/tbody){website}
  - >-
    [MDN docs for
    tfoot](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/tfoot){website}
  - >-
    [Codepen Example thead, tbody and
    tfoot](https://codepen.io/stefan-stojanovic/pen/jKbJgQ){website}
  - >-
