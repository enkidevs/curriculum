...
The list separated by commas define the _(x,y)_ coordinates for each point. Translated into _px_, its equivalent would be `polygon(0px 0px, 300px 150px, 0px 150px)`. Three points will determine a triangle.
...
**Note:** Top-left corner of the `element` is located at _(0%,0%)_, while the bottom-right one at _(100%, 100%)_.
