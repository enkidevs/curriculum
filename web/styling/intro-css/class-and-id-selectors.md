...
Class selectors are more specific than _type selectors_ because they select a smaller group of elements rather than all of one type. In the style sheet, they are always invoked with a period before the name of the class:
...
Which of the following selectors does _always_ target a single element?
