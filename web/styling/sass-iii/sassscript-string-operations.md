...
The `+` operation is used in _SassScript_ for the concatenation of strings.
...
Within a text string, _`#{} style interpolation`_ can be used to place dynamic values into a string:
